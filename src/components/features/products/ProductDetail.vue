              ...
              <div class="row">
                <div class="owl-carousel2">
                  <div class="item">
                    <div class="col">
                      <h3>
                        <a>25% off (Almost) Everything! Use Code: Summer Sale</a>
                      </h3>
                    </div>
                  </div>
                  <div class="item">
                    <div class="col">
                      <h3>
                        <a>Our biggest sale yet 50% off all summer shoes</a>
                      </h3>
                    </div>
                  </div>
                </div>
...
export default {
  ...
  beforeMount() {
    ...
    this.loadSync().then(resp => console.log(resp));

    // let data = await this.loadASync();
    // console.log(data);
    // this.loadSync().then(resp => console.log(resp));
    // for (let i = 0; i < 1000000000; ) {
    //   i++;
  ...
  async mounted() {
    ...
    console.log("mounted");
    console.time("mouted");
    this.$store.dispatch("loadData", { id: this.productId });

    // let data = await this.loadSync();
    // console.log(data);
    // this.loadSync().then(resp => console.log(resp));

    console.timeEnd("mouted");
    ...
    // };
    // console.log(obj2);
    // let getAD = function({ a,b }, { e }) {
    //   return a + b + e;
    // };
    // console.log("getAD", getAD(obj1, obj2));
  ...
  computed: {
    productDetail2: () => {
      console.log(mapState(["productDetail"]));

      return mapState(["productDetail"]);
    },
